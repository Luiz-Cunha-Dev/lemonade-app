...
abstract class AbstractDAO {
     ...
     * @return array number of elements
     */
    final protected function countAllElementsByParameter($tableName, $parameterToCompare, $parameterToSearch) {

        try {

            $sql = 'SELECT COUNT(1) AS ' . '"' . $tableName . 'Count"' . ' FROM ' . $tableName . ' WHERE ' . $parameterToCompare . ' = ' . $parameterToSearch;
