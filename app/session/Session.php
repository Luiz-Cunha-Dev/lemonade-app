...
class Session {
    ...
    public static function refreshSession($userId) {
        ...
        $_SESSION['user'] = [
            ...
            'postalCode' => $newUserData->getPostalCode(),
            'street' => $newUserData->getStreet(),
            'streetNumber' => $newUserData->getStreetNumber(),
            'city' => $newUserData->getIdCity(),
            'district' => $newUserData->getDistrict(),
            'complement' => $newUserData->getComplement(),
